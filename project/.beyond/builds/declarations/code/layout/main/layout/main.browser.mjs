...
const __pkg = new __Bundle({"module":{"vspecifier":"project@0.0.1/layout/main"},"type":"widget"}, import.meta.url).package();;
...
brequire('@beyond-js/widgets/render').widgets.register([{"name":"main-layout","vspecifier":"project@0.0.1/layout/main","is":"layout"}]);

brequire('@beyond-js/kernel/styles').styles.register('project@0.0.1/layout/main')
