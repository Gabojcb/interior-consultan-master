...
exports.hmr = exports.__beyond_pkg = exports.Menu = exports.Control = void 0;
...
__pkg.exports.process = function ({
  ...
  (require || prop === 'Control') && (exports.Control = Control = require ? require('./control').Control : value);
  (require || prop === 'Menu') && (exports.Menu = Menu = require ? require('./view/indext').Menu : value);
};
